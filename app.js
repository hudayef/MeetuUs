...
const app = {
    ...
    toggleAuthMode() {
        ...
        document.getElementById('auth-toggle-text').innerHTML = this.isLoginMode ?
            'Belum punya akun? <a href="#" onclick="event.preventDefault(); app.toggleAuthMode()">Daftar di sini</a>' :
            'Sudah punya akun? <a href="#" onclick="event.preventDefault(); app.toggleAuthMode()">Login di sini</a>';
    },
